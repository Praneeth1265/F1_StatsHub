...
DROP TRIGGER IF EXISTS PreventDuplicateResults;
DROP PROCEDURE IF EXISTS assign_points_for_race;
DROP PROCEDURE IF EXISTS add_result;
DROP PROCEDURE IF EXISTS RecalculateAllRaceRanks;
DROP FUNCTION IF EXISTS getDriverFullName;
